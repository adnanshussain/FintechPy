...
def q1_aggregate(setid, direction, percent, from_yr, to_yr, sort_order, top_n):
    return flask.render_template('publicweb/q1_individual.html', title='Insight #1', setid=setid, direction=direction,
...
def q1_individual(setid, seid, direction, percent, from_yr, to_yr):
    ...
    return flask.render_template('publicweb/q1_individual_old.html', title='Insight #1.1', setid=setid, seid=seid,
                                 direction=direction,
                                 percent=float(percent),from_yr=from_yr, to_yr=to_yr, min_yr=1993, max_yr=2016,
