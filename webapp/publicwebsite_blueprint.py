...
@__pwbp.route('/q2/aggregate/<int:setid>/<int:from_yr>/<int:to_yr>') #, defaults = { 'sort_order':'desc', 'top_n':10 })
...
@__pwbp.route('/q2/aggregate/partial') # This route is specifically to satisfy jQuery Ajax calls with the url_for()
@__pwbp.route('/q2/aggregate/partial/<int:setid>/<int:from_yr>/<int:to_yr>') #, defaults = { 'sort_order':'desc', 'top_n':10 })
...
@__pwbp.route('/q2/individual/<int:setid>/<int:seid>/<int:from_yr>/<int:to_yr>') #, defaults = { 'sort_order':'desc', 'top_n':10 })
...
@__pwbp.route('/q2/individual/partial') # This route is specifically to satisfy jQuery Ajax calls with the url_for()
@__pwbp.route('/q2/individual/partial/<int:setid>/<int:seid>/<int:from_yr>/<int:to_yr>') #, defaults = { 'sort_order':'desc', 'top_n':10 })
